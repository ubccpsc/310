...
| **D4** | Fri 27 Nov, 18:00 | Build it *(pairs)* |
| **Final** | Scheduled by the university | 2.5 hours, cumulative |
...
| 3 | Sep 22, 24 | | <a href="/310/26w1/lectures/03a-refactoring.pdf" target="_blank">Refactoring</a> · <a href="/310/26w1/lectures/03b-testability.pdf" target="_blank">Testability</a> | Lab 3 — refactoring & testability *(Sep 25–Oct 1)* ⚠ Wed Sep 30 | **D1** Fri Sep 25 |
| 4 | Sep 29, Oct 1 | | Testability · Test Doubles, DIP & LSP | Lab 4 — testability, dip, lsp *(Oct 2–8)* | — |
