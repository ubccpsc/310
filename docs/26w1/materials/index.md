...
| [Unit 4 — Process, CI & DevOps](unit-04/) | 12–13 | Across a team | How several people change one codebase without breaking each other, and what has to be automated for that to hold |
...
**[Unit 3 — Requirements & specification](unit-03/)** · weeks 9–11 · *in progress*

**[Unit 4 — Process, CI & DevOps](unit-04/)** · weeks 12–13 · *in progress*
