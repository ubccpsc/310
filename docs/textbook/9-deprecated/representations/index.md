...
![uml diagram overview](uml-overview.png)
...
![UML Class Diagram modeling course enrolment.](uml-class-enrolment.png)
<!-- Mermaid code
...
![state diagram](uml-state-water.png)
...
![state diagram](uml-state-promises.png)
