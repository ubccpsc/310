...
The materials have been adapted over several years of use:
some concepts in the reader  are taught slightly differently in class than they appear in the reader (but especially the videos).
<!-- although each section of the course may use different subsets of the readings and videos.
...
::: details Introduction to running example

<Youtube id="S4GEa6JMo4I" />
