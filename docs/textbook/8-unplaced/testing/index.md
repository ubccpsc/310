...
[//]: # (* [x] [Interpreted vs Complied Languages]&#40;/textbook/construction/languages/#interpreted-vs-compiled&#41;)

[//]: # (* [x] Static vs Dynamic Representations of the System)

[//]: # (* [x] [Static vs Dynamic Types]&#40;/textbook/construction/languages/#static-vs-dynamic-types&#41;)

[//]: # (  :::)


<Youtube id="Uamo4Ej0tWk" />
...
* ```Glass box testing```: When testing in a glass box manner one typically carefully examines the program source code in order to identify potentially problematic sets of inputs or control flow paths. More details can be found in the [Glass box testing](/textbook/8-unplaced/testing/glassbox/) reading.
* ```Black box testing```: Black box testing validates programs without any knowledge of how the system is implemented. This form of testing relies heavily on predicting problematic inputs by examining public API signatures and any available documentation for the CUT. More details can be found in the [Black box testing](/textbook/8-unplaced/testing/blackbox/) reading.
...
::: details Comparing unit and system tests

<Youtube id="x2DWjxDiOQo" />
